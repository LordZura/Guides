...
-- This function calculates a guide's overall rating based on reviews of all their tours
...
-- Create or replace the main get_review_summary function to handle both tour and guide aggregation
